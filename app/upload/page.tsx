    ...
    return (
      <div className="mx-auto max-w-[480px] px-8 py-[120px] text-center">
        ...
        <button
          onClick={connect}
          disabled={connecting}
          className="bg-shelgreen text-[#050505] font-semibold text-[15px] px-6 py-[14px] rounded-[8px] hover:bg-shelgreen-dark hover:-translate-y-[1px] hover:shadow-[0_0_0_4px_rgba(139,197,63,0.3)] transition-all duration-150 disabled:opacity-60"
        >
